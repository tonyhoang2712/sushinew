...
<script type="text/javascript">
	jQuery(document).on("click", "input.input-text.qty.text[type=number]", function(e) {
		jQuery(".page-cart button.button.button-update-cart-page").removeAttr('disabled');
	})
	jQuery(document).on("click", "button.qty_button", function(e) {
		jQuery(".page-cart button.button.button-update-cart-page").removeAttr('disabled');
	})
</script>
